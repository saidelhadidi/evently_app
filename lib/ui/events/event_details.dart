...
import 'package:evently_app/ui/events/widgets/action_button.dart';
import 'package:evently_app/ui/events/widgets/event_description_label.dart';
import 'package:evently_app/ui/events/widgets/event_time_label.dart';
...
class EventDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isOwner = event.uid == currentUserUid;
    return Scaffold(
      appBar: AppBar(
        leadingWidth: 50,
